                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="parent_code" name="parent_code" class="form-control form-control-alternative" placeholder="Parent Code..." value="<?php echo $result['parent_code'];?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
