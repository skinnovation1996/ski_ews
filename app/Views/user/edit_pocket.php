        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Pocket</h4>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="16" id="pocket_id" name="pocket_id" class="form-control form-control-alternative" placeholder="Pocket ID..." value="<?php echo $pocket['pocket_id'];?>" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label class="form-control-label" for="budget_amt">Budget Amount (RM)</label>
                                        <input type="num" id="budget_amt" name="budget_amt" class="form-control form-control-alternative" placeholder="Budget Amount (RM)..." value="<?php echo $pocket['budget_amt'];?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="purchase_item_name">Pocket Item Name</label>
                                        <input type="text" id="purchase_item_name" name="purchase_item_name" class="form-control form-control-alternative" placeholder="Pocket Item Name..." value="<?php echo $pocket['purchase_item_name'];?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
