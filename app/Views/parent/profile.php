                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="parent_id" name="parent_id" class="form-control form-control-alternative" placeholder="Autogenerated..." value="<?php echo $parent['parent_id'];?>" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <div class="form-group">
                                        <label class="form-control-label" for="name">User Name</label>
                                        <input type="text" id="name" name="name" class="form-control form-control-alternative" placeholder="User Name..." value="<?php echo $parent['name'];?>"  required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" name="email" class="form-control form-control-alternative" placeholder="E-Mail Address..." value="<?php echo $parent['email'];?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
